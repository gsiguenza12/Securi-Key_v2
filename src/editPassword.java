...
public class editPassword extends JFrame {
	...
	private JLabel lblB = new JLabel("edit your passwords");
	...
	private void initComponent(){
		...
		txtA.setBounds(35,35,250,100);
    int test = MyFrame.readFile("User.txt");
    txtA.setText(String.valueOf(test));
		//txtB.setBounds(200,35,100,20);
		//txtC.setBounds(200,65,100,20);
	
		lblB.setBounds(100,10,500,20);
