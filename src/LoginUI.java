...
public class LoginUI extends JFrame {
    ...
    private LoginUI() {
        ...
        controller = new Controller(mainJPanel);
    }
    ...
    private void addLogo(JPanel panel1) {
        ...
        label1.setIcon(new ImageIcon(requireNonNull(getClass().getClassLoader().getResource("SecuriKey_Logo_placeholder.png")).getFile()));
        panel1.add(label1);
        label1.setBounds(55, 146, 200, 110);
    }

    private void addUsernameTextField(JPanel panel1) {
        final TextFieldUsername usernameField = new TextFieldUsername();
    ...
    private void addPasswordTextField(JPanel panel1) {
        final TextFieldPassword passwordField = new TextFieldPassword();
    ...
    private void addLoginButton(JPanel panel1) {
        ...
        final JLabel loginButton = new JLabel() {
            @Override
    ...
    private void addForgotPasswordButton(JPanel panel1) {
        panel1.add(new HyperlinkText(UIUtils.BUTTON_TEXT_FORGOT_PASS, 423, 300, new Runnable() {
            @Override
            public void run() {
                controller.error("Forgot password event");
            }
        }));
    }

    private void addRegisterButton(JPanel panel1) {
        panel1.add(new HyperlinkText(UIUtils.BUTTON_TEXT_REGISTER, 631, 300, new Runnable() {
            @Override
            public void run() {
                controller.success("Register event");
            }
        }));
    }

    private void loginEventHandler() {
        controller.warn("Login event");
    }
}
